...
/* BNS v466 driver: archief nooit op telefoon */
(function(){
  if(window.__BNS_V466_DRIVER_NO_ARCHIVE__) return;
  window.__BNS_V466_DRIVER_NO_ARCHIVE__=true;
  function isArch(o){
    var id=String((o&&(o.id||o.docId||o.orderId))||"");
    var f=String((o&&(o.folder||o.map||o.orderFolder))||"").toLowerCase();
    return id.indexOf("old_")===0 || f==="archief" || f==="old";
  }
  if(typeof visibleOrder==="function" && !visibleOrder.__bns466){
    var oldVisible=visibleOrder;
    visibleOrder=function(o){
      if(isArch(o)) return false;
      return oldVisible(o);
    };
    visibleOrder.__bns466=true;
  }
})();
